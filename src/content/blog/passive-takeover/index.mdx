...
import ShodanMessage from "./images/shodan-message.png";
import VisitIp from "./images/visit-ip.png";
import MysteryMessage from "./images/mysterymessage.png";
...
<Fig src={ShodanMessage} caption="Shodan result showing a result with 'Subdomain Takeover' in the title" />

Opening up in a browser reveals:

<Fig src={VisitIp} caption="Visiting the IP displays an odd splash screen" />
...
<Fig src={MysteryMessage} caption="Visiting the domain reveals its true intention" />
...
<Fig src={Pwned} caption="Successfully taking over an A record as demonstrated by the HTTP response" />
